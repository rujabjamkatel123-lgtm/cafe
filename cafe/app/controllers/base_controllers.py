...
=============================================================
  ...
  - Child classes (AuthController, MenuController, OrderController)
...
class BaseController:
    ...
    def get_form_data(self, *fields):
        ...
        Example:
            name, email = self.get_form_data(
                "name",
                "email"
            )

        Returns stripped strings with no extra spaces.
        """
